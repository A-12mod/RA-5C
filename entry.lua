...
InputProfiles =
	{
		["RA-5C"] = current_mod_path .. '/Input/RA-5C',
	},
})
----------------------------------------------------------------------------------------
mount_vfs_model_path	(current_mod_path.."/Shapes")
mount_vfs_liveries_path (current_mod_path.."/Liveries")
mount_vfs_texture_path  (current_mod_path.."/Textures/RA-5C")
mount_vfs_Sounds_path	(current_mod_path.."/Sounds/EditorMusic")
----------------------------------------------------------------------------------------
--make_flyable('RA-5C',current_mod_path..'/Cockpit/Scripts/RA-5C',, current_mod_path..'/Comm.lua')--make_flyable('RA-5C',current_mod_path..'/Cockpit/KneeboardRight/',{nil, old = 6}, current_mod_path..'/Comm.lua')----------------------------------------------------------dofile(current_mod_path.."/LUA/Views_F15Pit.lua")
