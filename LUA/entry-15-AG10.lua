...
make_flyable('VSN_MirageIIIS',current_mod_path..'/Cockpit/KneeboardRight/',{nil, old = 6}, current_mod_path..'/comm.lua')--SFM
-------------------------------------------------------------------------------------
dofile(current_mod_path.."/LUA/Views_F15Pit.lua")
make_view_settings('VSN_MirageIIIC', ViewSettings, SnapViews)
make_flyable('VSN_MirageIIIC',current_mod_path..'/Cockpit/KneeboardRight/',{nil, old = 6}, current_mod_path..'/comm.lua')--SFM
-------------------------------------------------------------------------------------
dofile(current_mod_path.."/entry-15-AG10SFM.lua")
make_view_settings('VSN_MirageIIIC_AG', ViewSettings, SnapViews)
make_flyable('VSN_MirageIIIC_AG',current_mod_path..'/Cockpit/KneeboardRight/',{nil, old = 17}, current_mod_path..'/comm.lua')--SFM
-------------------------------------------------------------------------------------
